...
public class FlashCodeBuilder extends OopCodeBuilder {
	...
	@Override
	public void buildServerApi(ApiGate gate) {
		throw new IllegalStateException("Not supported");
	}

	@Override
	public void buildClientApi(ApiGate gate) {
		ClientApiBuilder builder = new ClientApiBuilder(gate.getName());
	...
	private class ClientApiBuilder extends SubPackageBuilder {

		public ClientApiBuilder(String gateName) {
			super(gateName);
		}
...
//					.addStatement(statementIf)
		...
		private void buildServerApi(List<ApiService> services) {
			...
			method.getArgument("gate").setType(pack.getClass("ApiGate"));
		...
		private CodeClass buildServerService(ApiService service) {
			...
			cls.setParent(engine.getClass("org.shypl.biser.api.client.ServerService"));
		...
		private CodeClass buildServerServiceActionResult(ApiService service, ApiAction action) {
			...
			holderClass.addImplement(engine.getClass("org.shypl.biser.api.client.ResultHandlerHolder"));
