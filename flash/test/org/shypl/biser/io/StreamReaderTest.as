package org.shypl.biser.io {
	...
	public class StreamReaderTest {
		...
		public function testReadUint():void {
			//arrange
			const expectedValues:Array = [2147483648, 4294967168, 4294967169, 4294967295, 0, 127, 128, 253, 254, 2147483647];
			const data:Array = Utils.intsToBytes([
				0xFE, 0x80, 0x00, 0x00, 0x00, // 2147483648
		...
		public function testReadMap():void {
			//arrange
			const expectedValues:Array = [null, new LinkedMap(), new LinkedMap()];
		...
		public function testReadArrayOfMap():void {
			//arrange
			const expected:Array = [null, new LinkedMap(), new LinkedMap()];
			expected[2].put("A", "B");
		...
		public function testReadMapOfArray():void {
			//arrange
			const expected:Map = new LinkedMap();
