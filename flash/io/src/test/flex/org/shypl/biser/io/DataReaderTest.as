package org.shypl.biser.io {
	...
	public class DataReaderTest {
		...
		public function testReadByte():void {
			...
			const reader:DataReader = new DataReader(stream);
		...
		public function testReadUlong():void {
			...
			const expectedValues:Array = [
				Long.valueOf("-9223372036854775808"), Long.valueOf(-2147483648), Long.valueOf(-128), Long.valueOf(-127), Long.valueOf(-1), Long.valueOf(0),
				Long.valueOf(127), Long.valueOf(128), Long.valueOf(254), Long.valueOf(255), Long.valueOf(2147483647), Long.valueOf("9223372036854775807")
			];
			const data:Array = Utils.intsToBytes([
				0xFF, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // -9223372036854775808
				0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, 0x00, 0x00, 0x00, // -2147483648
				0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, // -128
				0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x81, // -127
				0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, // -1
				0x00, // 0
				0x7F, // 127
				0x80, // 128
				0xFE, // 254
				0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, // 255
				0xFF, 0x00, 0x00, 0x00, 0x00, 0x7F, 0xFF, 0xFF, 0xFF, // 2147483647
				0xFF, 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, // 9223372036854775807
