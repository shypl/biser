...
public class WebSocketSecureFrameHandler extends SimpleChannelInboundHandler<BinaryWebSocketFrame> implements Channel, ChannelFutureListener {
	...
	public WebSocketSecureFrameHandler(ChannelAcceptor acceptor) {
