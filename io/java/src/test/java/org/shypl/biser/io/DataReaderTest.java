...
public class DataReaderTest {
	...
	@Test
	public void testReadArrayOfMap() {
		//arrange
		@SuppressWarnings("unchecked")
		final Map<String, String>[] expectedValues = new Map[3];
		expectedValues[0] = null;
	...
	@Test
	public void testReadArrayOfArrayOfMap() {
		//arrange
		@SuppressWarnings("unchecked")
	...
	@Test
	public void testReadMapOfArray() {
		//arrange
		@SuppressWarnings("unchecked")
