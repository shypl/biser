package org.shypl.biser.io {
	...
	public class DataWriterTest {
		...
		public function testWriteByte():void {
			...
			const writer:DataWriter = new DataWriter(stream);
		...
		public function testWriteUint():void {
			//arrange
			const values:Array = [0, 127, 128, 254, 255, 2147483647, 4294967295];
		...
		public function testWriteDouble():void {
			...
			for each (value in values) {
				DoubleEncoder.INSTANCE.encode(value, writer);
			}
		...
		public function testWriteMap():void {
			//arrange
			const values:Array = [null, new LinkedHashMap(), new LinkedHashMap()];
			values[2].put("A", "B");
